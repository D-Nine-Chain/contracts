...
mod mining_pool {
    ...
    mod tests {
        ...
        fn create_default_mining_pool() -> MiningPool {
        ...
        fn test_price_precision_constants() {
            ...
            assert_eq!(MiningPool::PRICE_STORAGE_KEY, 999_999_999);
            assert_eq!(MiningPool::PRICE_PRECISION, 1_000_000);
            assert_eq!(MiningPool::PERCENT_PROTECT, 70);
        }
    ...
    mod e2e_tests {
        ...
        async fn default_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let contract_account_id = client
                .instantiate("mining_pool", &ink_e2e::alice(), constructor, 0, None)
                .await
                .expect("instantiate failed")
                .account_id;

            // Then
            let get = build_message::<MiningPoolRef>(contract_account_id.clone())
                .call(|mining_pool| mining_pool.get());
        ...
        async fn it_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let contract_account_id = client
                .instantiate("mining_pool", &ink_e2e::bob(), constructor, 0, None)
                .await
                .expect("instantiate failed")
                .account_id;
            ...
            // When
            let flip = build_message::<MiningPoolRef>(contract_account_id.clone())
                .call(|mining_pool| mining_pool.flip());
